...
class TestImport:
    ...
    def test_import_unsafe(self, windows_registry):
        for_import = {
            wp(r"ControlSet001\Control\Bluetooth\Audio\Hfp\HandsFree"): {'"Custom"': "dword:00000120"},
            wp(r"ControlSet001\Control\Bluetooth\Audio\Hfp\HandsFree\Sub"): {'"CustomSub"': "dword:00000121"},
        }
        ...
        key = wp(r"ControlSet001\Control\Bluetooth\Audio\Hfp\HandsFree")
        assert reg_data.get(key, '"ProfileVersion"') == "dword:00000107", "existing values remain the same"
    ...
    def test_import_safe(self, windows_registry, sample_reg_file_path, registry_file_path):
        ...
        for_import = {wp(r"ControlSet001\Control\Bluetooth\Audio\Hfp\HandsFree"): {'"ProfileVersion"': new_value}}
