...
def extract_info(device_info_path: str) -> dict[str, str | None | dict[str, str]]:
    ...
    Returns:
        hash: Kind of { name:, class:, pairing_key:, pairing_type:, pairing_data: }
    """
    config = ConfigParser()
    ...
    if link_key is not None:
        ...
        pairing_data = {
            ...
            "EDiv": config.get(long_term_key_section, "EDiv", fallback="0"),
            "Rand": config.get(long_term_key_section, "Rand", fallback="0"),
        }
